...
export class Navbar extends Component {
    render() {
        return(
            <div>
                <nav className="navbar fixed-top navbar-expand-lg" style={{backgroundColor: "#2d3334"}}>
                    <div className="container-fluid">
                        <Link className="navbar-brand" style={{color: "white"}} to="/"><strong>Newsly</strong></Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul  className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li className="nav-item"><Link style={{color: "white"}} className="nav-link" aria-current="page" to="/">Home</Link></li>
                                <li className="nav-item"><Link style={{color: "white"}} className="nav-link" to="/politics">Politics</Link></li>
